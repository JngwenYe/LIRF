...
__all__ = ['ResNet', 'ResNet18', 'ResNet18_low', 'ResNet18_up', 'ResNet34', 'ResNet50', 'ResNet101', 'ResNet152']
...
class ResNet_low(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10):
        super(ResNet_low, self).__init__()
        self.in_planes = 64
...
def ResNet18low(num_class=10):
    return ResNet_low(BasicBlock, [2,2,2,2], num_classes=num_class)

def ResNet18up(num_class=10):
    return ResNet_up(BasicBlock, [2,2,2,2], num_classes=num_class)
